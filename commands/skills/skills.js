module.exports = {
  ...
  stun: {
    title: ['Fatal Blow', 'Power Arrow', 'Magical Shock'],
    titleFr: ['Coup Fatal', 'Assaut de flèche', 'Choc Magique'],
    thumbnail: ['Fatal_Blow.png', 'Power_Arrow.png', 'Magical_Shock.png'],
    aliases: ['Stun', 'Fatal Blow', 'Power Arrow', 'Magical Shock', 'Coup Fatal', 'Assaut de flèche', 'Choc Magique', 'H01', 'H07'],
  ...
  double: {
    title: ['Double Attack', 'Double Strafe', 'Magical Double Hit'],
    titleFr: ['Double Attaque', 'Double Mitrailler', 'Frappe Magic Double'],
    thumbnail: ['Double_Attack.png', 'Double_Strafe.png', 'Magical_Double_Hit.png'],
    aliases: ['Double', 'Double Attack', 'Double Strafe', 'Magical Double Hit', 'Double Attaque', 'Double Mitrailler', 'Frappe Magic Double', 'H03', 'H14'],
  ...
  frost: {
    title: ['Frost Blade', 'Frost Bolt', 'Stone Curse'],
    titleFr: ['Lame de givre', 'Eclair de givre', 'Pierre de Malédiction'],
    thumbnail: ['Frost_Blade.png', 'Frost_Bolt.png', 'Stone_Curse.png'],
    aliases: ['Frost', 'Frost Blade', 'Frost Bolt', 'Stone Curse', 'Lame de givre', 'Eclair de givre', 'Pierre de Malédiction', 'H04', 'H16'],
  ...
  sleep: {
    title: ['Sleeping Blade', 'Sleep Bolt', 'Sleep'],
    titleFr: ['Lame de sommeil', 'Eclair sommeil', 'Sommeil'],
    thumbnail: ['Sleeping_Blade.png', 'Sleep_Bolt.png', 'Sleep.png'],
    aliases: ['Sleep', 'Sleeping Blade', 'Sleep Bolt', 'Sleep', 'Lame de sommeil', 'Eclair sommeil', 'Sommeil', 'H06', 'H21'],
  ...
  silence: {
    title: ['Blade of Silence', 'Silent Bolt', 'Silence'],
    titleFr: ['Lame de silence', 'Eclair silencieux', 'Silence'],
    thumbnail: ['Blade_of_Silence.png', 'Silent_Bolt.png', 'Silence.png'],
    aliases: ['Silence', 'Blade of Silence', 'Silent Bolt', 'Silence', 'Lame de silence', 'Eclair silencieux', 'Silence', 'H11', 'H26'],
  ...
  hit: {
    title: ['Spear Dynamo', 'Meditation', 'Element Focus'],
    titleFr: ['Lance dynamo', 'Méditation', 'Elément Cible'],
    thumbnail: ['Spear_Dynamo.png'],
    aliases: ['HIT', 'Spear Dynamo', 'Meditation', 'Element Focus', 'Lance dynamo', 'Méditation', 'Elément Cible', 'H12', 'H27'],
  ...
  dexterity: {
    title: ['Dexterity', 'Windwalker'],
    titleFr: ['Dextérité', 'Marcheur de vent'],
    thumbnail: ['Dexterity.png'],
    aliases: ['Dexterity', 'Dexterity', 'Windwalker', 'Dexterity', 'Dextérité', 'Marcheur de vent', 'Dextérité', 'H14', 'H28'],
    desc: 'Increases EVA. ',
  ...
  triple: {
    title: ['Triple Action', 'Triple Strafe', 'Mental Power'],
    titleFr: ['Triple Action', 'Triple Tir', 'Pouvoir Mental'],
    thumbnail: ['Triple_Action.png', 'Triple_Strafe.png', 'Mental_Power.png'],
    aliases: ['Triple', 'Triple Action', 'Triple Strafe', 'Mental Power', 'Triple Action', 'Triple Tir', 'Pouvoir Mental', 'H15', 'H31'],
    desc: 'Improve HIT greatly. And it lasts for a long period. ',
    descFr: '',
  ...
  curse: {
    title: ['Cursed Blade', 'Curse Bolt', 'Curse Magic'],
    titleFr: ['Lame de malédiction', 'Eclair de malédiction', 'Malédiction magique'],
    thumbnail: ['Cursed_Blade.png', 'Curse_Bolt.png', 'Curse_Magic.png'],
    aliases: ['Curse', 'Cursed Blade', 'Curse Bolt', 'Curse Magic', 'Lame de malédiction', 'Eclair de malédiction', 'Malédiction magique', 'H18', 'H35'],
  ...
  speed: {
    ...
    aliases: ['Speed', 'Speed Burst', 'Vitesse Limite', 'H20', 'H38'],
  ...
  h23: {
    title: ['Furious Blow', 'Fury Arrow', 'Energy Reflection'],
    titleFr: ['Coup féroce', 'Flèche de Furie', 'Réflexion énergétique'],
    thumbnail: ['Furious_Blow.png', 'Fury_Arrow.png', 'Energy_Reflection.png'],
    aliases: ['H23', 'Furious Blow', 'Fury Arrow', 'Energy Reflection', 'Coup féroce', 'Flèche de Furie', 'Réflexion énergétique', 'H23', 'H41'],
  ...
  h32: {
    title: ['Charged Attack', 'Aimed Bolt', 'Element Bomb'],
    titleFr: ['Assaut', 'Tir ciblé', 'Element Bombe'],
    thumbnail: ['Charged_Attack.png', 'Aimed_Bolt.png', 'Element_Bomb.png'],
    aliases: ['H32', 'Charged Attack', 'Aimed Bolt', 'Element Bomb', 'Assaut', 'Tir ciblé', 'Element Bombe', 'H32', 'H46'],
  ...
  bleed: {
    title: ['Vital Strike', 'Falcon Eyes', 'Thunderous Shot'],
    titleFr: ['Attaque ingénieuse', 'Sniper', 'Tir tonitruant'],
    thumbnail: ['Vital_Strike.png', 'Falcon_Eyes.png', 'Thunderous_Shot.png'],
    aliases: ['Bleed', 'Vital Strike', 'Falcon Eyes', 'Thunderous Shot', 'Attaque ingénieuse', 'Sniper', 'Tir tonitruant', 'H34', 'H47'],
  ...
  h36: {
    title: ['Pierce', 'Ghost Arrow', 'Fire Wall'],
    titleFr: ['Attaque perçante', 'Flèche Magique', 'Mur de Feu'],
    thumbnail: ['Pierce.png', 'Ghost_Arrow.png', 'Fire_Wall.png'],
    aliases: ['H36', 'Pierce', 'Ghost Arrow', 'Fire Wall', 'Attaque perçante', 'Flèche Magique', 'Mur de Feu', 'H36', 'H49'],
  ...
  h39: {
    title: ['Traumatic Blow', 'Vulnerability Mark', 'Magical Chase'],
    titleFr: ['Coup Traumatique', 'Opportuniste', 'Chasse Magique'],
    thumbnail: ['Traumatic_Blow.png', 'Vulnerability_Mark.png', 'Magical_Chase.png'],
    aliases: ['H39', 'Traumatic Blow', 'Vulnerability Mark', 'Magical Chase', 'Coup Traumatique', 'Opportuniste', 'Chasse Magique', 'H39', 'H50'],
  ...
  lifeSteal: {
    title: ['Blade of Blood', 'Blood Steal', 'Energy Transfer'],
    titleFr: ['Lame de sang', 'Vampire', 'Transfert énergétique'],
    thumbnail: ['Blade_of_Blood.png', 'Blood_Steal.png', 'Energy_Transfer.png'],
    aliases: ['Life Steal', 'Blade of Blood', 'Blood Steal', 'Energy Transfer', 'Lame de sang', 'Vampire', 'Transfert énergétique', 'H40', 'H51'],
  ...
  bash: {
    title: ['Bash', 'Brutal Arrow', 'Mindblow'],
    titleFr: ['Attaque sauvage', 'Flèche Brutale', 'Hallucination'],
    thumbnail: ['Bash.png', 'Brutal_Arrow.png', 'Mindblow.png'],
    aliases: ['Bash', 'Bash', 'Brutal Arrow', 'Mindblow', 'Attaque sauvage', 'Flèche Brutale', 'Hallucination'],
  ...
  guardian: {
    ...
    aliases: ['Guardian', 'Guardian', 'Gardien'],
  ...
  energyCoat: {
    title: ['Energy Coat'],
    titleFr: ['Manteau énergétique'],
    thumbnail: ['Energy_Coat.png'],
    aliases: ['Energy Coat', 'Energy Coat', 'Manteau énergétique'],
  ...
  windCutter: {
    ...
    aliases: ['Wind Cutter', 'Wind Cutter', 'Lame venteuse'],
  ...
  toxic: {
    ...
    aliases: ['Toxic', 'Toxic Arrow', 'Flèche Toxique'],
  ...
  jackFrost: {
    ...
    aliases: ['Jack Frost', 'Jack Frost', 'Jack Frost'],
